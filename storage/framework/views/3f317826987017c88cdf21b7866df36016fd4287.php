...
<div>
    <div class="row align-items-center mb-3">
        <div class=" col-md-8">
            <h1 class="" style="word-wrap: break-word;"><?php echo e($type->name); ?> Competitions</h1>
        </div>
        <div class="col-md-4 d-flex  justify-content-md-end"">
            <a href="/competitions" class="btn btn-lg wide btn-solid btn-light btn-outline-primary text-uppercase " style="border: 2px solid; max-height:80px; ">
            <span> Go Back</span>
            </a>
        </div>
    </div>
...
<?php echo $__env->make('layouts.authorized', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Computer\Tutorials\virtualCompetitions\resources\views/competitions/showbytype.blade.php ENDPATH**/ ?>
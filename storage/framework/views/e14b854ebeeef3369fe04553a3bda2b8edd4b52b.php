    ...
    <div class="row">
        <div class="col-12">
            <div class="row mx-1 my-2">
                ...
                <a href="/competitions/<?php echo e($sportType->name); ?>" class="btn btn-lg wide btn-solid btn-light btn-outline-primary text-uppercase mx-0" style="border: 2px solid">
...
<?php echo $__env->make('layouts.authorized', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Computer\Tutorials\virtualCompetitions\resources\views/competitions/index.blade.php ENDPATH**/ ?>
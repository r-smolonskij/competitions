...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('css/theme-vendors.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('css/theme.min.css') }}">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <link rel="stylesheet" href="{{ URL::asset('css/theme-color/theme-modern-one.css') }}">
    ...
    <script src="{{ URL::asset('vendors/modernizr.min.js')}}"></script>
...
<body class="footer-fixed header-side">
    ...
    <div id="wrap">
        ...
        <body class="footer-fixed header-side">
                    ...
                    <div class="main-bar-container main-bar-side" style="overflow-y: auto !important; overflow-x:hidden">
                        <div class="main-bar pt-0">
                            <div class="navbar-header d-lg-none d-xl-none py-0 px-0">
                                <a href="/profile/{{$authorizedUser->id}}" class="navbar-brand "><img src="{{ URL::asset('./images/logo/logo-dark.png')}}"></a>
                            ...
                            <!-- /.navbar-header --><a href="/profile/{{$authorizedUser->id}}" class="navbar-brand d-md-none d-sm-none d-lg-inline-block d-xl-inline-block px-0 mr-0"><span class="brand-inner"><img src="{{ URL::asset('./images/logo/logo-light.png')}}"></span></a>
                            <div id="main-header-nav" class="collapse navbar-collapse my-0">
                                <ul id="menu-primary" class="nav navbar-nav main-nav">

                                    <li class="menu-item menu-item-has-children" style="padding-left: 15px !important"><a href="/profile/{{$authorizedUser->id}}" class="pl-3"><img src="{{ $authorizedUser->profile->profileImage() }}" alt="" class="rounded-circle mx-2" style="height: 25px; "><span class="link-txt">{{$authorizedUser->name }}</span></a>
                                        <ul class="nav-item-children">
                                            <li class="menu-item"><a href="/profile/{{$authorizedUser->id }}"><span class="link-txt">View Profile</span></a></li>
                                            @can('update', $authorizedUser->profile )
                                            <li class="menu-item"><a href="/profile/{{$authorizedUser->id }}/edit"><span class="link-txt">Edit Profile</span></a></li>
                                            @endcan
                                        </ul>
                                    </li>
                                    ...
                                    <hr class="w-100 border-white mt-0" />
                                    <li class="menu-item "><a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="menu-item">
            ...
            <script src="{{ URL::asset('js/theme.vendors.min.js') }}"></script>
